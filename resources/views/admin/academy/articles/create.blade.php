...
<div class="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-extrabold text-slate-900">Tambah Materi Edukasi</h1>
        <p class="mt-2 text-sm text-slate-500">Materi baru akan langsung tersedia di halaman Green Academy user.</p>
    </div>

    <form action="{{ route('admin.academy.articles.store') }}" method="POST">
        @csrf
