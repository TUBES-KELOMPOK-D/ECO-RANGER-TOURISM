...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->middleware(AdminMiddleware::class)->group(function () {
        ...
        Route::get('/leaderboard/admin/point-rules', [LeaderboardController::class, 'managePointRules'])->name('leaderboard.admin.point_rules');
        Route::post('/leaderboard/admin/point-rules', [LeaderboardController::class, 'storePointRule'])->name('leaderboard.admin.point_rules.store');
        Route::put('/leaderboard/admin/point-rules/{rule}', [LeaderboardController::class, 'updatePointRule'])->name('leaderboard.admin.point_rules.update');
        Route::post('/leaderboard/admin/point-rules/{rule}/delete', [LeaderboardController::class, 'destroyPointRule'])->name('leaderboard.admin.point_rules.destroy');
        
        Route::get('/leaderboard/admin/badges', [LeaderboardController::class, 'manageBadges'])->name('leaderboard.admin.badges');
        Route::post('/leaderboard/admin/badges', [LeaderboardController::class, 'storeBadge'])->name('leaderboard.admin.badges.store');
        Route::put('/leaderboard/admin/badges/{badge}', [LeaderboardController::class, 'updateBadge'])->name('leaderboard.admin.badges.update');
        Route::post('/leaderboard/admin/badges/{badge}/delete', [LeaderboardController::class, 'destroyBadge'])->name('leaderboard.admin.badges.destroy');

        Route::get('/leaderboard/admin/vouchers', [LeaderboardController::class, 'manageVouchers'])->name('leaderboard.admin.vouchers');
        Route::post('/leaderboard/admin/vouchers', [LeaderboardController::class, 'storeVoucher'])->name('leaderboard.admin.vouchers.store');
        Route::put('/leaderboard/admin/vouchers/{voucher}', [LeaderboardController::class, 'updateVoucher'])->name('leaderboard.admin.vouchers.update');
        Route::post('/leaderboard/admin/vouchers/{voucher}/delete', [LeaderboardController::class, 'destroyVoucher'])->name('leaderboard.admin.vouchers.destroy');

        Route::get('/leaderboard/admin/tips', [LeaderboardController::class, 'manageTips'])->name('leaderboard.admin.tips');
        Route::post('/leaderboard/admin/tips', [LeaderboardController::class, 'storeTip'])->name('leaderboard.admin.tips.store');
        Route::put('/leaderboard/admin/tips/{tip}', [LeaderboardController::class, 'updateTip'])->name('leaderboard.admin.tips.update');
        Route::post('/leaderboard/admin/tips/{tip}/delete', [LeaderboardController::class, 'destroyTip'])->name('leaderboard.admin.tips.destroy');

        Route::post('/leaderboard/admin/reset', [LeaderboardController::class, 'resetLeaderboard'])->name('leaderboard.admin.reset');
        Route::post('/leaderboard/admin/adjust', [LeaderboardController::class, 'adjustPoints'])->name('leaderboard.admin.adjust');
