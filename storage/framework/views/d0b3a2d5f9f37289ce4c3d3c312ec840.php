<?php $__env->startSection('title', 'Profil Saya - GreenTour'); ?>
        ...
        <div class="rounded-3xl bg-white p-8 shadow-soft border border-slate-200">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <a href="<?php echo e(route('reports.index')); ?>" class="rounded-full border border-slate-200 bg-slate-100 px-5 py-3 text-sm font-semibold text-slate-700 hover:bg-slate-200">Lihat Laporan</a>
                </div>
            </div>
            ...
            <div class="mt-10 overflow-hidden rounded-[2rem] bg-gradient-to-r from-emerald-600 to-toscagreen p-8 text-white shadow-xl sm:p-10">
                <div class="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
                    <div>
                        ...
                        <p class="mt-3 text-4xl font-black"><?php echo e(number_format($user->eco_points)); ?></p>
                    </div>
                    <div class="flex items-center justify-between gap-4 rounded-3xl bg-white/10 p-4 shadow-inner shadow-slate-950/10 md:w-[320px]">
                        <div>
                            ...
                            <p class="mt-1 text-lg font-semibold"><?php echo e($user->eco_level); ?></p>
                        </div>
                        <div class="rounded-3xl bg-white/20 px-4 py-3 text-sm font-bold uppercase tracking-[0.2em] text-white"><?php echo e($user->eco_level); ?></div>
                    </div>
                </div>
                ...
                <div class="mt-8 rounded-[2rem] bg-white/10 p-6">
                    <div class="flex items-center justify-between gap-4 text-sm font-semibold text-white/90">
                        ...
                        <span><?php echo e(number_format($progress)); ?>%</span>
                    </div>
                    <div class="mt-4 h-3 overflow-hidden rounded-full bg-white/20">
                        <div class="h-full rounded-full bg-white shadow-lg shadow-white/20" style="width: <?php echo e(max(0, min(100, $progress))); ?>%"></div>
                    </div>
                    <p class="mt-3 text-xs text-white/80"><?php echo e($user->eco_points); ?> poin terkumpul. <?php echo e($nextLevel['remaining']); ?> poin lagi ke level berikutnya.</p>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\ECO-RANGER-TOURISM\eco-ranger-tourism\resources\views/Profile/index.blade.php ENDPATH**/ ?>