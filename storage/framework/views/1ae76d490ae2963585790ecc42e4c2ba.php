...
<?php endif; ?>
    ...
    <div class="max-w-sm w-full bg-white p-8 rounded-3xl shadow-sm border border-slate-100 text-center">
        ...
        <p class="mt-4 text-center text-sm text-slate-500">Sudah punya akun? <a href="<?php echo e(route('login')); ?>" class="text-emerald-600 font-bold decoration-transparent">Login</a></p>
    </div>
</body>
</html><?php /**PATH D:\Project\ECO-RANGER-TOURISM\eco-ranger-tourism\resources\views/auth/register.blade.php ENDPATH**/ ?>