    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20 items-center">
            ...
            <a href="/" class="flex items-center gap-3 cursor-pointer group hover:opacity-80 transition-opacity decoration-transparent">
                ...
                <span class="text-xl font-black tracking-tighter text-slate-800">Pak<span class="text-emerald-600">Eco</span></span>
            </a>
            ...
            <div class="hidden md:flex items-center gap-1 lg:gap-4">
                ...
                @auth
                    <button class="ml-4 w-10 h-10 rounded-full flex items-center justify-center font-bold border-2 transition-all bg-emerald-100 text-emerald-700 border-emerald-500 hover:scale-110">
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-white border-b border-slate-100 shadow-xl absolute w-full left-0 transition-all">
        <div class="px-4 pt-2 pb-6 space-y-1">
            ...
            <div class="pt-4 border-t border-slate-50">
                @auth
                    <button class="flex items-center gap-3 w-full p-4 rounded-2xl font-bold bg-slate-50 text-slate-700 hover:bg-slate-100 transition-all">
